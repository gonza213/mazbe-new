        ...
        <div class="container-fluid">
            <div class="grid grid-cols-1 relative">
                <div class="tiny-five-item">
                    ...
                    <div v-for="product in products" :key="product.id" class="tiny-slide">
                        <div
                            class="group relative overflow-hidden p-2 rounded-lg bg-white dark:bg-slate-900 border border-gray-100 dark:border-gray-800 hover:shadow-md dark:shadow-md hover:dark:shadow-gray-700 transition-all duration-500 h-fit m-2">
                            <div class="relative overflow-hidden">
                                ...
                                <div
                                    class="absolute top-2 end-2 opacity-0 group-hover:opacity-100 transition-all duration-500">
                                ...
                                <div v-if="product.showdate === true"
                                    ...
                                    <i class="uil uil-clock align-middle me-1"></i> <small id="auction-item-1"
                                        class="font-bold">{{
                            ...
                            <div class="mt-3">
                                <div class="flex items-center">
                                    ...
                                    <router-link to="/creator-profile"
                                        class="ms-2 text-[15px] font-medium text-slate-400 hover:text-violet-600">{{
                        product.name
                    }}</router-link>
                                </div>
...
import auctions from '@/components/live-auctions.vue';
