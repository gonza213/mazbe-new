<template>
    ...
    <!-- Start Hero -->
    <section class="relative table w-full py-36 bg-[url('https://res.cloudinary.com/dazfmv5ls/image/upload/v1722831535/bg3_agrxbq.png')] bg-bottom bg-no-repeat">
