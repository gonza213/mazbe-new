                        ...
                        <div class="grid grid-cols-1">
                            ...
                            <form class="text-start">
                                <div class="grid grid-cols-1">
                                    ...
                                    <div class="mb-4">
                                        <input type="submit" class="btn bg-violet-600 hover:bg-violet-700 border-violet-600 hover:border-violet-700 text-white rounded-full w-full" value="Send">
                                    </div>

                                    <div class="text-center">
                                        <span class="text-slate-400 me-2">Remember your password ? </span><router-link to="/login" class="text-black dark:text-white font-bold">Sign in</router-link>
                                    </div>
                                </div>
                            </form>
                        </div>
