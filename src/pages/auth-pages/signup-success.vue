                ...
                <div class="lg:w-2/5">
                    <div
                        ...
                        <div class="px-6 py-12 text-center">
                            ...
                            <p class="text-slate-400 mt-4">Your account has been successfully created. <br> Enjoy your
                                journey. Thank you</p>

                            <div class="mt-6">
                                <router-link to="/"
                                    class="btn bg-violet-600 hover:bg-violet-700 border-violet-600 hover:border-indigobg-violet-700 text-white rounded-md">Continue</router-link>
                            </div>
                        </div>

                        <div class="text-center p-6 border-t border-gray-100 dark:border-gray-700">
                            <p class="mb-0 text-slate-400">© {{ date }} Giglink. Design with <i
