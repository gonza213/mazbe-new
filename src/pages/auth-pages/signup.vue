        ...
        <div class="container">
            <div class="flex justify-center">
                <div
                    ...
                    <form action="/signup-success" class="text-start">
                        <div class="grid grid-cols-1">
                            ...
                            <div class="flex items-center mb-4">
                                <input
                                    class="form-checkbox rounded border-gray-200 dark:border-gray-800 text-violet-600 focus:border-violet-600/30 focus:ring focus:ring-offset-0 focus:ring-violet-600/20 focus:ring-opacity-50 me-2"
                                    type="checkbox" value="" id="AcceptT&C">
                                <label class="form-checkbox-label text-slate-400" for="AcceptT&C">I Accept <a href=""
                                        class="text-violet-600">Terms And Condition</a></label>
                            </div>

                            <div class="mb-4">
                                <input type="submit"
                                    class="btn bg-violet-600 hover:bg-violet-700 border-violet-600 hover:border-violet-700 text-white rounded-full w-full"
                                    value="Register">
                            </div>

                            <div class="text-center">
                                <span class="text-slate-400 me-2">Already have an account ? </span> <router-link to="/login"
                                    class="text-black dark:text-white font-bold">Sign in</router-link>
                            </div>
                        </div>
                    </form>
                </div>
