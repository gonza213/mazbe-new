<template>
     <!-- Start -->
     <section class="relative bg-[url('../../assets/images/bg/bg2.jpg')] bg-no-repeat bg-center">
                ...
                <div class="grid grid-cols-1">
                    <div class="flex flex-col min-h-screen justify-center md:px-10 py-10 px-4">
                        <div class="text-center">
                            <img src="../../assets/images/logo-white.png" class="mx-auto h-7" alt="">
                        </div>
                        <div class="title-heading text-center my-auto">
                            <div class="md:my-0 my-10">
                                ...
                                <p class="text-white/70 max-w-xl mx-auto">We are a huge marketplace dedicated to connecting great artists of all Giglink with their fans and unique token collectors!</p>
                            
                                <div id="countdown">
                                    <ul class="count-down list-none inline-block text-white text-center mt-8">
                                        <li id="days" class="count-number inline-block m-2">{{ days }}<p class="count-head">Days
                                    </p></li>
                        ...
                        <div class="text-center">
                            <p class="mb-0 text-white">© {{date1}} Giglink. Design with <i class="mdi mdi-heart text-red-600"></i> by <a href="https://shreethemes.in/" target="_blank" class="text-reset">Shreethemes</a>.</p>
                        </div>
                    </div>
                </div><!--end grid-->
            </div><!--end container-->
