<template>
    <div class="container">
        <div class="md:flex justify-center">
            <div class="lg:w-3/4">
                <div
                    class="lg:flex justify-center p-6 bg-white dark:bg-slate-900 rounded-md shadow dark:shadow-gray-800">
                    <div class="lg:w-1/3 md:w-full">
                        <p class="font-semibold mb-6">Upload your ART here, Please click "Upload Image" Button.</p>
                        <div v-if="imageSrc === null ? 'hiiden' : ''"
                        ...
                        <input type="file" id="input-file" name="input-file" accept="image/*" @change="loadFile"
                            hidden />
                        <label
                            class="btn-upload btn bg-violet-600 hover:bg-violet-700 border-violet-600 hover:border-violet-700 text-white rounded-full w-full mt-6 cursor-pointer"
                    ...
                    <div class="lg:w-2/3 md:w-full mt-8 lg:mt-0 lg:ms-6">
                        <form>
                            <div class="grid grid-cols-1 gap-6">
                                ...
                                <div class="text-start">
                                    <label for="name" class="font-semibold">URL:</label>
                                    <input name="url" id="giglink-url" type="url"
                                        class="form-input w-full text-[15px] py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded-full outline-none border border-gray-200 focus:border-violet-600 dark:border-gray-800 dark:focus:border-violet-600 focus:ring-0 mt-2"
                                        placeholder="https://giglink.exe/streetboyyy">
                                </div>

                                <div class="text-start">
                                    <label for="comments" class="font-semibold">Bio:</label>
                                ...
                                <div class="text-start">
                                    <label for="name" class="font-semibold">Twitter Account:</label>
                                    <p class="text-slate-400 text-[15px]">Link your twitter account to gain more trust
                                ...
                                <button type="submit" id="submit" name="send"
                                    class="btn bg-violet-600 hover:bg-violet-700 border-violet-600 hover:border-violet-700 text-white rounded-full justify-center flex items-center">Create
                                    your account</button>
                            </div>
                        </form>
                    </div>
