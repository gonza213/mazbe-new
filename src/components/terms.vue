                    ...
                    <div class="md:w-3/4">
                        <div class="p-6 bg-white dark:bg-slate-900 shadow dark:shadow-gray-800 rounded-md">
                            ...
                            <ul class="list-none text-slate-400 mt-3">
                                <li v-for="item in restrictions" :key="item" class="flex mt-2"><i class="uil uil-arrow-right text-violet-600 text-lg align-middle me-2"></i>{{item}}</li>
                            </ul>
                            ...
                            <div class="mt-6">
                                ...
                                <a href="" class="btn bg-transparent hover:bg-violet-600 border-violet-600 text-violet-600 hover:text-white rounded-md ms-2">Decline</a>
                            </div>
                        </div>
                    </div><!--end -->
                </div><!--end grid-->
...
const restrictions = ref(['Digital Marketing Solutions for Tomorrow', 'Our Talented & Experienced Marketing Agency', 'Create your own skin to match your brand', 'Digital Marketing Solutions for Tomorrow', 'Our Talented & Experienced Marketing Agency', 'Create your own skin to match your brand']) 
