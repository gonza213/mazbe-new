<template>
     ...
     <div class="fixed top-[25%] -left-2 z-50 hidden sm:block">
        ...
        <div v-if="back" class="fixed bottom-3 end-3 z-3">
            <router-link to="/" class="back-button btn btn-icon bg-violet-600 hover:bg-violet-700 border-violet-600 hover:border-violet-700 text-white rounded-full"><i data-feather="arrow-left" class="h-4 w-4"></i></router-link>
        </div>
