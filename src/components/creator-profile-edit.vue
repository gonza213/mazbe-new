        ...
        <div class="grid md:grid-cols-12 gap-[30px]">
            <div class="lg:col-span-3 md:col-span-4">
                <div class="group profile-pic w-[112px]">
                    ...
                    <div>
                        <div
                            class="relative h-28 w-28 rounded-full shadow-md dark:shadow-gray-800 ring-4 ring-slate-50 dark:ring-slate-800 overflow-hidden">
            ...
            <div class="lg:col-span-9 md:col-span-8">
                ...
                <div class="p-6 rounded-md shadow dark:shadow-gray-800 bg-white dark:bg-slate-900 mt-[30px]">
                    ...
                    <div v-for="item in datas" :key="item" class="md:flex mt-8 first:mt-0">
                        <div class="md:w-1/3">
                        ...
                        <div class="md:w-2/3 mt-4 md:mt-0">
                            <form>
                                <div class="form-icon relative">
                                    <i :data-feather="item.icon" class="w-4 h-4 absolute top-3 start-4"></i>
                                    <input type="text"
                                        class="form-input w-full text-[15px] ps-12 py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded-full outline-none border border-gray-200 focus:border-violet-600 dark:border-gray-800 dark:focus:border-violet-600 focus:ring-0"
                                        :placeholder="item.place" id="twitter_name" name="name" required="">
                                </div>
                            </form>
                    ...
                    <div class="md:flex">
                        <div class="md:w-full">
                            ...
                            <button
                                class="btn bg-violet-600 hover:bg-violet-700 border-violet-600 hover:border-violet-700 text-white rounded-full mt-5">Save
                ...
                <div class="p-6 rounded-md shadow dark:shadow-gray-800 bg-white dark:bg-slate-900 mt-[30px]">
                    ...
                    <div class="flex justify-between pb-4">
                        ...
                        <div class="">
                            <input
                                class="form-checkbox rounded border-gray-200 dark:border-gray-800 text-violet-600 focus:border-violet-600/30 focus:ring focus:ring-offset-0 focus:ring-violet-600/20 focus:ring-opacity-50"
                ...
                <div class="p-6 rounded-md shadow dark:shadow-gray-800 bg-white dark:bg-slate-900 mt-[30px]">
                    ...
                    <router-link to="/explore-two"
                        class="btn bg-red-600 hover:bg-red-700 border-red-600 hover:border-red-700 text-white rounded-full">Delete</router-link>
                </div>
            </div>
        </div><!--end grid-->
    </div><!--end container-->
...
<script setup>
import images from '../assets/images/avatar/1.jpg'
import { ref} from 'vue';
